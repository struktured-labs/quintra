#!/bin/bash
# v24: Train from gameplay_start.state (full level 1) starting from BC pretrain.
# Goal: emerge a nav+combat policy that handles whole level 1.
...
print(f'v24: BC init, gameplay_start.state, max_steps=18000, ent=0.01')
