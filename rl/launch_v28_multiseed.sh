#!/bin/bash
# v28 multi-seed sweep — 3 seeds in series. Look for replicate of v19 ep200's 100% det multi-kill.
# Each: BC + PPO from gargoyle.state, 1500 epochs, ckpts every 25.
SEED=$1
LABEL="v28s${SEED}"
...
print(f'Device: {device}, label={LABEL}, seed=$SEED, n_envs={n_envs}, epochs={epochs}')
