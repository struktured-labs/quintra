#!/bin/bash
# v23: RESUME v22 ep1300 with v19's setup. Test if v18→v19 path replicates.
...
RESUME = '/home/struktured/projects/penta-dragon-dx-claude/rl/ppo_v22_repro_ep1300.pt'
...
print(f'v23: Resumed v22 ep1300, max_steps=15000')
