...
The freshly rerun v0.18.0 15/15 matrix has complete telemetry and encounters
every roster member, but does **not** pass this gate yet: Picsean now wins all
3/3 complete nine-boss runs, while Wolfkin, Sauran, Corvin, and Vespine are
still 0/3.
