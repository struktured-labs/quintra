#!/usr/bin/env python3
"""
v1.08: Different boss palettes + new BG colors

Boss detection via 0xFFBF:
  - 0xFFBF = 1 → Gargoyle → ALL enemies palette 6
  - 0xFFBF = 2 → Spider → ALL enemies palette 7
  - 0xFFBF = 0 → Normal tile-based coloring

BG Palette 0 (Level 1): White, Light blue, Blackish yellow
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v108.gb")
    ...
    print("\n=== v1.08: Different Boss Palettes + New BG Colors ===")
    print("  Boss detection via 0xFFBF:")
    print("    0xFFBF = 1 → Gargoyle → ALL enemies palette 6")
    print("    0xFFBF = 2 → Spider → ALL enemies palette 7")
    print("    0xFFBF = 0 → Normal tile-based coloring")
    print("  BG Palette 0: White, Light blue, Blackish yellow")
    print()
