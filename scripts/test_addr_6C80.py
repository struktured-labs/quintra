...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_ADDR6C80.gb")
    ...
    colorizer_addr = 0x6C80
    colorizer_main_addr = 0x6CA0
    combined_addr = 0x6CD0
    ...
    print(f"Colorizer at: 0x{colorizer_addr:04X}, Combined at: 0x{combined_addr:04X}")
