...
# The foyer and sustained 248x248 fields make this 32,000-frame input-only
# route substantially heavier on the host; the cartridge frame cap, seed, and
# room-29 contract stay exact.
QUINTRA_BOT_EASY=1 QUINTRA_BALANCE_RUNS=4 QUINTRA_BALANCE_CLASSES=0 \
  QUINTRA_BALANCE_TARGET_FRAME=460 \
  QUINTRA_BALANCE_FRAMES=32000 QUINTRA_BALANCE_HOST_TIMEOUT=1200 \
