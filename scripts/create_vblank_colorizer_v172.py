#!/usr/bin/env python3
"""
v1.72: BG Colorizer - VBK fix

- Fix: Explicitly set VBK=0 before reading tiles (was using random VBK state)
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v172.gb")
    ...
    print("\n=== v1.72: BG Colorizer - VBK Fix ===")
    print("  Fix: Set VBK=0 before reading tiles")
    print()
