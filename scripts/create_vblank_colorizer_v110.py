#!/usr/bin/env python3
"""
v1.10: Crow tile fix + palette verification

Changes from v1.09:
  - FIX: Crow tiles (0x30-0x3F) now get palette 3 instead of default palette 4
  - Added palette verification test infrastructure

Tile-based coloring:
  - 0x00-0x0F: Effects/projectiles (palette 0)
  - 0x20-0x27: Sara W (palette 2)
  - 0x28-0x2F: Sara D (palette 1)
  - 0x30-0x3F: Crow (palette 3) [NEW]
...
def create_tile_based_colorizer() -> bytes:
    ...
    - Otherwise tile-based:
      - 0x30-0x3F: Crow (palette 3) [NEW in v1.10]
      - 0x40-0x4F: Hornets (palette 4)
      - 0x50-0x5F: Orcs (palette 5)
      - 0x60-0x6F: Humanoids (palette 6)
      - 0x70-0x7F: Miniboss (palette 7)
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v109.gb")
    ...
    print("\n=== v1.09: Dynamic Boss Palette Loading ===")
