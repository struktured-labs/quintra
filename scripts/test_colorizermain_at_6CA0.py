#!/usr/bin/env python3
"""
Test: Colorizer_main at 0x6CA0, but colorizer stays at 0x6C00.
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_CMAIN_6CA0.gb")
    ...
    colorizer_addr = 0x6C00       # Working address
    colorizer_main_addr = 0x6CA0  # TEST ADDRESS
    combined_addr = 0x6C50        # Working address
    ...
    print(f"Combined at: 0x{combined_addr:04X} (working)")
    print(f"Colorizer_main at: 0x{colorizer_main_addr:04X} (TEST)")
    print(f"Colorizer at: 0x{colorizer_addr:04X} (working)")
