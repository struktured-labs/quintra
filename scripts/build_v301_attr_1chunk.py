#!/usr/bin/env python3
"""v3.01 with attr_computation reduced to 1 chunk (3 rows × 24 tiles).
...
Output: rom/working/penta_dragon_dx_v301_attr_1chunk.gb
"""
import sys
...
def create_attr_computation_1chunk(bg_table_addr: int) -> bytes:
    ...
    # 3 rows
    code.extend([0x3E, 0x03])                     # LD A, 3 (row counter)
...
def build():
    ...
    output_path = Path("rom/working/penta_dragon_dx_v301_attr_1chunk.gb")
