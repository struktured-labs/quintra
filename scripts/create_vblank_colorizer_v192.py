#!/usr/bin/env python3
"""
v1.92: Reduced tiles per frame (4 instead of 8)

- Full address calculation but only 4 tiles/frame
- Tests if reducing VBlank work fixes Sara corruption
- 256 steps to cover full tilemap (32 rows * 8 chunks)
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v192.gb")
    ...
    print("\n=== v1.92: Reduced tiles (4 instead of 8) ===")
    print("  Full address calc but only 4 tiles/frame")
    print("  Tests if reducing VBlank work fixes corruption")
    print()
