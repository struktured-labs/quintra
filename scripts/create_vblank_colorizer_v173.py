#!/usr/bin/env python3
"""
v1.73: BG Colorizer - safer HRAM address

- Changed counter from 0xFFC0 to 0xFFC4 (0xFFC0 may conflict with game)
- Changed WRAM buffer from 0xDFF0 to 0xD900 (safer location)
- Set VBK=0 before reading tiles
- Only processes 8 tiles per frame
- Checks for Sara in OAM
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v173.gb")
    ...
    print("\n=== v1.73: BG Colorizer - Safer HRAM ===")
    print("  Changed counter to 0xFFC4, buffer to 0xD900")
    print()
