#!/usr/bin/env python3
"""
v1.79: BG Colorizer - VBK SWITCH only test

- Tests if VBK switching causes freeze
- Switches to VBK=1 and back, no write
"""
import sys
import yaml
...
def create_bg_row_colorizer_lazy(lookup_table_addr: int) -> bytes:
    ...
    # Don't write anything, just switch back
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v179.gb")
    ...
    print("\n=== v1.79: BG Colorizer - VBK SWITCH only ===")
    print("  VBK 0->1->0, no write")
    print()
