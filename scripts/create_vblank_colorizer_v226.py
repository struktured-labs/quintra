#!/usr/bin/env python3
"""
v2.26: v2.25 + Simple BG Colorization (Bank 1 Only)
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v226.gb")
    ...
    print("\n=== v2.26: v2.25 + Simple BG Colorization ===")
    print("  OBJ: Tile-based + dynamic boss palette swapping")
    print("  BG: One-shot colorization (1 row per VBlank)")
    print("  All code in bank 1 (no bank switching)")
    print()
    ...
    # 0x6900: OBJ colorizer (~98 bytes)
    # 0x6980: Shadow main (~52 bytes)
    # 0x69E0: Palette loader (~68 bytes)
    # 0x6B00: BG lookup table (256 bytes)
    # 0x6C00: BG colorizer (~70 bytes)
