#!/usr/bin/env python3
"""
Test: Same as ZEROBG_GRAYOBJ but at address 0x6D00.
Finding the boundary where code stops working.
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_ADDR6D00.gb")
    palette_path = Path("palettes/penta_palettes_v097.yaml")

    print("=== Test: Same as ZEROBG_GRAYOBJ but at 0x6D00 addresses ===")
    ...
    colorizer_addr = 0x6D00       # TEST ADDRESS
    colorizer_main_addr = 0x6D20  # TEST ADDRESS
    combined_addr = 0x6D50        # TEST ADDRESS
