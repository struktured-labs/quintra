...
def main():
    ...
    output_rom = project_root / "rom/working/penta_dragon_dx_v224_obj_only.gb"
    ...
    print("\n=== v2.24: OBJ-ONLY Test (BG Disabled) ===")
    print("  PURPOSE: Isolate BG corruption by testing OBJ-only")
