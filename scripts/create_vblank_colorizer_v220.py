#!/usr/bin/env python3
"""
v2.20: OBJ Colorization (v2.19) + Safe One-Shot BG Colorization
...
def main():
    ...
    output_rom = project_root / "rom/working/penta_dragon_dx_v220.gb"
    ...
    print("\n=== v2.20: OBJ Colorization + Safe One-Shot BG Colorization ===")
    print("  OBJ: Same as v2.19 (working)")
    print("  BG: One-shot approach - colorizes once per level entry")
    print("    - 2 rows per VBlank (safe timing)")
    print("    - Full screen in 9 VBlanks (~150ms)")
    print("    - NO BG work after completion until next level")
    print()
