#!/usr/bin/env python3
"""
v1.60: v1.09 + BG Colorization (Minimal Changes)

Same as v1.09 but adds BG colorization with LCD check.
The key change: add bg_colorizer call to combined function.
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v160.gb")
    ...
    print("\n=== v1.60: v1.09 + BG Colorization ===")
    print("  v1.09 sprite colorization + BG tile coloring")
    print("  LCD check: skips BG colorization during early boot")
    print()
