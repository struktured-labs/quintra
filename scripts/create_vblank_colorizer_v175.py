#!/usr/bin/env python3
"""
v1.75: BG Colorizer - remove Sara check

- Re-enabled BG colorizer
- Removed Sara presence check (may be causing freeze by reading hardware OAM)
- Always run BG colorizer (will colorize title screen too)
"""
import sys
import yaml
...
def main():
    ...
    output_rom = Path("rom/working/penta_dragon_dx_v175.gb")
    ...
    print("\n=== v1.75: BG Colorizer - No Sara Check ===")
    print("  Removed Sara check (may have caused freeze)")
    print()
