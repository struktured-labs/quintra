...
def main(path):
    ...
    if len(rom) != 256 * 1024:
        fail(f"expected current 256 KiB image, got {len(rom)} bytes")
    ...
    expected = {
        ...
        0x148: (0x03, "256 KiB ROM size code"),
    ...
    print("[cartridge] PASS QUINTRA, 256KiB CGB-only, MBC5+32KiB battery RAM, checksums valid")
