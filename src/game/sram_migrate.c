...
void sram_migrate_run(u8 saved_rs) BANKED {
    ...
    if (saved_rs == PRE_MAZE_MAP_RS_SIZE) {
        ...
        else if (stage == 3 && run_state.room_counter == 45)
            run_state.room_counter = 63;
        else if (stage == 6 && run_state.room_counter == 97)
            run_state.room_counter = 136;
        else {
