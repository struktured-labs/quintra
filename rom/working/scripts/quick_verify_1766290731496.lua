...
local screenshotBase = "/home/struktured/projects/penta-dragon-dx-claude/rom/working/verify_screenshot_"
local screenshotCount = 0
local frameCount = 0
local screenshotIntervalFrames = 600  -- Frames between screenshots

console:log("Quick verification: Taking screenshots every " .. screenshotIntervalFrames .. " frames")
console:log("Note: Fast forward enabled - Python will kill after 10 seconds")
