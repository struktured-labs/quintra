...
local maxFrames = 360  -- 6 seconds total (360 frames = 6s at 60fps)

console:log("Quick verification: Capturing screenshots for 5 seconds")

-- Function to log sprite tile IDs and positions
local function logSpriteTiles()
    local logFile = io.open(screenshotBase .. "tile_ids.txt", "w")
    if logFile then
