...
local screenshotInterval = 0.16666666666666666  -- Seconds between screenshots (6 per second)
...
local function logSpriteTiles()
    ...
    if logFile then
        logFile:write(string.format("Screenshot %d (time %.2fs):\n", screenshotCount, os.clock() - startTime))
        local spriteCount = 0
        for i = 0, 39 do
