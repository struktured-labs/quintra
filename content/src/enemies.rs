...
pub const HORNET: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 7, damage: 1, speed: 96, score: 15, weakness: 0x02, poise: 0 },
...
pub const SKELETON: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 10, damage: 1, speed: 64, score: 20, weakness: 0x08, poise: 1 },
    ai_script:  AiScriptId::Chaser,
    drop_table: DROP_SMALL_COIN,
    biomes:     &[BIOME_CRYSTAL_CAVERNS],
};
...
pub const WISP: Enemy = Enemy {
    ...
    palette:    OBJ_PAL_BONE,
    stats: EnemyStats { hp: 7, damage: 1, speed: 32, score: 25, weakness: 0x04, poise: 0 },
...
pub const SHADE: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 9, damage: 2, speed: 48, score: 45, weakness: 0x08, poise: 0 },
...
pub const ROPE: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 8, damage: 2, speed: 64, score: 20, weakness: 0x01, poise: 0 },
...
pub const FOLDING_STAR: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 18, damage: 2, speed: 56, score: 60, weakness: 0x08, poise: 2 },
...
pub const FLUTTERBAT: Enemy = Enemy {
    ...
    palette: OBJ_PAL_BONE,
    stats: EnemyStats { hp: 6, damage: 1, speed: 80, score: 18, weakness: 0x04, poise: 0 },
...
pub const GLOAM_LEECH: Enemy = Enemy {
    ...
    palette: OBJ_PAL_RED,
    stats: EnemyStats { hp: 10, damage: 1, speed: 72, score: 35, weakness: 0x02, poise: 0 },
...
pub const RIFT_OOZE: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 14, damage: 1, speed: 40, score: 45, weakness: 0x01, poise: 2 },
    ai_script: AiScriptId::Walker, drop_table: DROP_SMALL_COIN,
    biomes: &[BIOME_CRYSTAL_CAVERNS],
};
...
pub const MIRROR_MOTH: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 10, damage: 1, speed: 48, score: 38, weakness: 0x01, poise: 1 },
...
pub const MIRE_SPORE: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 13, damage: 1, speed: 0, score: 42, weakness: 0x02, poise: 1 },
...
pub const ECHO_GUARD: Enemy = Enemy {
    ...
    stats: EnemyStats { hp: 18, damage: 2, speed: 56, score: 58, weakness: 0x10, poise: 3 },
