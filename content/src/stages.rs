...
pub const STAGES: [StageTheme; 9] = [
    ...
    StageTheme {
        ...
        enemy_pool: &[(5, 25), (3, 25), (6, 25), (16, 25)],
    },
    ...
    StageTheme {
        ...
        enemy_pool: &[(12, 15), (5, 15), (6, 20), (15, 25), (17, 25)],
    },
    ...
    StageTheme {
        ...
        enemy_pool: &[(7, 25), (3, 20), (5, 20), (11, 15), (19, 20)],
    },
    ...
    StageTheme {
        ...
        enemy_pool: &[(3, 18), (7, 18), (11, 22), (8, 17), (20, 13), (21, 12)],
    },
    ...
    StageTheme {
        ...
        enemy_pool: &[(7, 17), (11, 17), (15, 20), (19, 18), (20, 15), (21, 13)],
    },
];
